<?php
    ...
    $con="UPDATE principal set Password=:newpassword where id=:empid";
            ...
            <div class="login-box ptb--100">
                ...
                <form method="POST" name="signin">
                    <div class="login-form-head">
                        ...
                        <p>Please provide your principal details for recovery.</p>
                    </div>
                ...
                $empid=$_POST['empid'];
                $email=$_POST['emailid'];
                $sql ="SELECT id FROM principal WHERE email=:email and EmpId=:empid";
