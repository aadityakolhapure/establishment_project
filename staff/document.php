...
<body>
    ...
    <div class="container col-12 m-5">
      ...
      {
        $con = mysqli_connect("localhost","root","","establish
        ");

        $filename = $_FILES["establish"]["name"];
        $tempfile = $_FILES["establish"]["tmp_name"];
        ...
        <table class="table text-center">
            ...
            <?php
            $conn = mysqli_connect("localhost","root","","establish");
