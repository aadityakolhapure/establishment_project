                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="#">
                                <a href="uploaddoc.php" aria-expanded="true"><i class="ti-user"></i><span>Upload Document
                                    </span></a>
                            </li>
                                    ...
                                    <form action="upload.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Aadhar card</label>
                                                <input class="form-control" name="my_image" type="file">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">SSC Certificate</label>
                                                <input class="form-control" name="my_image" type="file">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">HSC Certificate</label>
                                                <input class="form-control" name="my_image" type="file">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">BE/B.TECH Certificate</label>
                                                <input class="form-control" name="my_image" type="file">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Experience Certificate</label>
                                                <input class="form-control" name="my_image" type="file">
                                            </div>
