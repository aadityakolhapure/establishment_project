<?php
    ...
    $con="UPDATE hod set Password=:newpassword where id=:empid";
            ...
            <div class="login-box ptb--100">
                ...
                <form method="POST" name="signin">
                    <div class="login-form-head">
                        ...
                        <p>Please provide your hod details for recovery.</p>
                    </div>
                ...
                $empid=$_POST['empid'];
                $email=$_POST['emailid'];
                $sql ="SELECT id FROM hod WHERE email=:email and EmpId=:empid";
